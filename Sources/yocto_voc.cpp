/*********************************************************************
 *
 * $Id: yocto_voc.cpp 12324 2013-08-13 15:10:31Z mvuilleu $
 *
...
YVoc::YVoc(const string& func): YFunction("Voc", func)
...
{
    if(YAPI::_YFunctionsCaches["YVoc"].find(func) != YAPI::_YFunctionsCaches["YVoc"].end())
        return (YVoc*) YAPI::_YFunctionsCaches["YVoc"][func];
    
    YVoc *newVoc = new YVoc(func);
    YAPI::_YFunctionsCaches["YVoc"][func] = newVoc ;
    return newVoc;
}
