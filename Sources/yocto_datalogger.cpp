/*********************************************************************
 *
 * $Id: yocto_datalogger.cpp 9425 2013-01-11 15:50:01Z seb $
 *
...
std::map<string,YDataLogger*> YDataLogger::_DataLoggerCache;
...
{
    if(YDataLogger::_DataLoggerCache.find(func) != YDataLogger::_DataLoggerCache.end())
        return YDataLogger::_DataLoggerCache[func];
    
    YDataLogger *newDataLogger = new YDataLogger(func);
    YDataLogger::_DataLoggerCache[func] = newDataLogger;
