/*********************************************************************
 *
 * $Id: yocto_pressure.cpp 12324 2013-08-13 15:10:31Z mvuilleu $
 *
...
YPressure::YPressure(const string& func): YFunction("Pressure", func)
...
{
    if(YAPI::_YFunctionsCaches["YPressure"].find(func) != YAPI::_YFunctionsCaches["YPressure"].end())
        return (YPressure*) YAPI::_YFunctionsCaches["YPressure"][func];
    
    YPressure *newPressure = new YPressure(func);
    YAPI::_YFunctionsCaches["YPressure"][func] = newPressure ;
    return newPressure;
}
