...
typedef void (*YGenericSensorUpdateCallback)(YGenericSensor *func, const string& functionValue);
 ...
 */
class YGenericSensor: public YFunction {
protected:
    // Attributes (function value cache)
    YGenericSensorUpdateCallback _callback;
    string          _logicalName;
...
public:
     ...
     * @noreturn
     */
    void registerValueCallback(YGenericSensorUpdateCallback callback);
     ...
     */
           static YGenericSensor* FindGenericSensor(const string& func);
    inline static YGenericSensor* Find(const string& func)
