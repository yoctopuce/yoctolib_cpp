/*********************************************************************
 *
 *  $Id: yocto_digitalio.cpp 56058 2023-08-15 07:38:35Z mvuilleu $
 *
...
{
    if (!(bitstate >= 0)) {
        _throw((YRETCODE)(YAPI_INVALID_ARGUMENT), "invalid bit state");
...
{
    if (!(bitdirection >= 0)) {
        _throw((YRETCODE)(YAPI_INVALID_ARGUMENT), "invalid direction");
        return YAPI_INVALID_ARGUMENT;
    }
    if (!(bitdirection <= 1)) {
        _throw((YRETCODE)(YAPI_INVALID_ARGUMENT), "invalid direction");
...
{
    if (!(bitpolarity >= 0)) {
        _throw((YRETCODE)(YAPI_INVALID_ARGUMENT), "invalid bit polarity");
        return YAPI_INVALID_ARGUMENT;
    }
    if (!(bitpolarity <= 1)) {
        _throw((YRETCODE)(YAPI_INVALID_ARGUMENT), "invalid bit polarity");
...
{
    if (!(opendrain >= 0)) {
        _throw((YRETCODE)(YAPI_INVALID_ARGUMENT), "invalid state");
        return YAPI_INVALID_ARGUMENT;
    }
    if (!(opendrain <= 1)) {
        _throw((YRETCODE)(YAPI_INVALID_ARGUMENT), "invalid state");
